...
export const translations = {
  en: {
    ...
    authorAndSuite: 'Jesse Lepota & Enterprise Media Suite',
    versionBadge: 'v1.1 Enterprise',
    streamLabel: 'Stream:',
  ...
  es: {
    ...
    authorAndSuite: 'Jesse Lepota y Suite Enterprise Media',
    versionBadge: 'v1.1 Enterprise',
    streamLabel: 'Emisión:',
  ...
  fr: {
    ...
    authorAndSuite: 'Jesse Lepota & Suite Media Entreprise',
    versionBadge: 'v1.1 Entreprise',
    streamLabel: 'Flux:',
    primaryServer: 'PRINCIPAL',
